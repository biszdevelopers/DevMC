...
A Windows-first, dependency-free Tkinter launcher for Paper 26.2, Youer 26.2, and legacy Mohist/Spigot 1.20.1 plugin development loops.
...
- Paper source: `%USERPROFILE%\Downloads\paper-26.2-124.jar`
- Youer source: `%USERPROFILE%\Downloads\youer-26.2-server.jar`
- Plugin project root: `D:\NewServer`
- Java: `C:\Program Files\Java\jdk-25\bin\java.exe` for Paper/Youer 26.2
- Initial/maximum heap: 1 GB / 4 GB

## Workflow

1. Choose an isolated Paper 26.2, Youer 26.2, Mohist 1.20.1, or Spigot 1.20.1 server profile. Paper and Youer require Java 25; the legacy profiles require Java 17.
...
Paper, Youer, and Spigot are imported directly from their selected local JARs; the launcher does not invoke BuildTools or require a network proxy. Use the matching **Import/Reimport** action after replacing a download. Youer profiles also expose the test-mod deployment controls used by the Mohist profile.
