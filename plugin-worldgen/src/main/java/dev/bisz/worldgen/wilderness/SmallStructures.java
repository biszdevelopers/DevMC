 ...
 * room with a spawner and the occasional cobweb. Kept within a single chunk so
 * the next regeneration of that chunk cleanly erases it. Used as a fallback
 * when no POI schematics are registered.
 */
