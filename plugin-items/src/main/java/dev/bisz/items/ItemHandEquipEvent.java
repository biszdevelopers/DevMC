...
/** Fired after an ItemLib item becomes active in either of a player's hands. */
public final class ItemHandEquipEvent extends Event {
  private static final HandlerList HANDLERS = new HandlerList();
  private final Player player;
  private final EquipmentSlot hand;
  private final DevItemStack item;

  public ItemHandEquipEvent(Player player, EquipmentSlot hand, DevItemStack item) {
